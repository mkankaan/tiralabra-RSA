...
- **Encryption:**
  ...
  *Inputs:*
  - ***Public key:*** A public key you received in the first step. Enter the public key of the person you want to send a message to.
...
- **Decryption:**
    ...
    *Inputs:*
    - ***Private key:*** A private key you received in the first step. Enter the private key of the person who will receive the message.
    - ***Ciphertext:*** Enter the ciphertext you got in the previous step.
